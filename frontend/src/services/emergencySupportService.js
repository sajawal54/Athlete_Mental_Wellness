...
export const emergencyService={
  ...
  getCounselor:async(id)=>{
    const response=await emergencyApi.get(`emergency/counselors/${id}/`);
    return response.data;
  },
  ...
  createCallbackRequest:async(data)=>{
    const response=await emergencyApi.post("emergency/callbacks/",data);
    return response.data;
  },
  getCallbackHistory:async()=>{
    const response=await emergencyApi.get("emergency/callbacks/history/");
    return response.data;
  },
};