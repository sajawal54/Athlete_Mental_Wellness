      ...
      `}>
        <div>
          ...
          >
            ...
            <p className="px-3 pb-2 text-[10px] font-bold tracking-widest text-slate-500 uppercase">Main Modules</p>
            {navigationItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  `}
                >
                  <Icon className={`w-4 h-4 transition-transform duration-200 group-hover:scale-110 ${active ? 'text-white' : 'text-slate-400 group-hover:text-indigo-400'}`} />
        ...
        <div className="p-3.5 border-t border-slate-800/80 m-3 bg-slate-900/60 rounded-2xl border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] text-slate-400">Secure Encrypted Session</p>
            </div>
          </div>
        </div>
      </aside>
